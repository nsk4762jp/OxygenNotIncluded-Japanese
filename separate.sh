...
msggrep -J -E -e "STRINGS.CLUSTER_NAMES" strings.po > po/cluster_names.po
msggrep -J -E -e 'STRINGS.CODEX' strings.po > po/codex.po
msggrep -J -E -e 'STRINGS.COLONY_ACHIEVEMENTS' strings.po > po/colony_achievements.po
...
msggrep -J -E -e 'STRINGS.GAMEPLAY_EVENTS' strings.po  > po/gameplay_events.po
msggrep -J -E -e 'STRINGS.INPUT\.' strings.po > po/input.po
msggrep -J -E -e 'STRINGS.INPUT_BINDINGS\.' strings.po > po/input_bindings.po
...
msggrep -J -E -e 'STRINGS.ROBOTS' strings.po  > po/robots.po
msggrep -J -E -e 'STRINGS.ROOMS' strings.po  > po/rooms.po
msggrep -J -E -e 'STRINGS.SUBWORLDS' strings.po  > po/subworlds.po
msggrep -J -E -e 'STRINGS.UI' strings.po  > po/ui.po
msggrep -J -E -e 'STRINGS.VIDEOS' strings.po  > po/videos.po
msggrep -J -E -e 'STRINGS.WORLDS' strings.po  > po/worlds.po
msggrep -J -E -e 'STRINGS.WORLD_TRAITS' strings.po  > po/world_traits.po
